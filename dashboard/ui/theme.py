...
def apply_theme():
    ...
    /* ── 20. SIDEBAR NAV — Rename "app" to "Home" ── */
    ...
    .eq-table tbody tr:nth-child(odd)  { background: #FFFFFF; }
    ...
    /* Risk pill badges inside tables */
    .eq-pill { padding: 4px 12px; border-radius: 12px; font-weight: 700; font-size: 0.78rem; display: inline-block; }
    .eq-pill-high   { background: #FEE2E2; color: #B91C1C !important; }
    .eq-pill-medium { background: #FEF3C7; color: #B45309 !important; }
    .eq-pill-low    { background: #DCFCE7; color: #166534 !important; }
